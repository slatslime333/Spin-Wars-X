...
const CACHE='spin-wars-x-9.30';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=9.30','./movement-engine.js?v=9.23','./xrail-engine.js?v=9.23',
  './vs-commentary.js?v=9.24','./abilities.js?v=9.27','./scoreboard.js?v=9.27','./app.js?v=9.28',
  './rogue-mode.js?v=9.29','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.0','./rogue-shop-balance.js?v=1.1',
