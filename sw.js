...
const CACHE='spin-wars-x-10.28';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=10.15','./ui-skin.css?v=10.00','./movement-engine.js?v=9.37','./xrail-engine.js?v=9.27',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.40','./scoreboard.js?v=10.05','./app.js?v=10.20',
  './rogue-mode.js?v=10.15','./sandbox-mode.js?v=10.09','./rogue-run-config.js?v=10.02','./rogue-run.js?v=10.15','./rogue-lite-config.js?v=1.2','./rogue-lite.js?v=1.5','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
