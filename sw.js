...
const CACHE='spin-wars-x-10.24';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=10.14','./ui-skin.css?v=10.00','./movement-engine.js?v=9.37','./xrail-engine.js?v=9.26',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.37','./scoreboard.js?v=10.01','./app.js?v=10.17',
  './rogue-mode.js?v=10.12','./sandbox-mode.js?v=10.09','./rogue-run-config.js?v=10.02','./rogue-run.js?v=10.13','./rogue-lite-config.js?v=1.0','./rogue-lite.js?v=1.3','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
