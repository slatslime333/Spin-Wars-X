...
const CACHE='spin-wars-x-9.35';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=9.35','./movement-engine.js?v=9.33','./xrail-engine.js?v=9.23',
  './vs-commentary.js?v=9.24','./abilities.js?v=9.27','./scoreboard.js?v=9.27','./app.js?v=9.35',
