...
const PRECACHE=[
  ...
  './rogue-mode.js?v=10.17','./sandbox-mode.js?v=10.09','./rogue-run-config.js?v=10.02','./rogue-run.js?v=10.15','./rogue-lite-config.js?v=1.2','./rogue-lite.js?v=1.9','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
