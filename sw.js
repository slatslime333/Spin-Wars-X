...
const PRECACHE=[
  ...
  './style.css?v=10.24','./ui-skin.css?v=10.03','./movement-engine.js?v=9.37','./xrail-engine.js?v=9.27',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.41','./scoreboard.js?v=10.05','./app.js?v=10.24',
  './rogue-mode.js?v=10.20','./sandbox-mode.js?v=10.09','./rogue-run-config.js?v=10.02','./rogue-run.js?v=10.16','./rogue-lite-config.js?v=1.4','./rogue-lite.js?v=1.14','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
