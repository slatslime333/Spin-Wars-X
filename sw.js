...
const CACHE='spin-wars-x-9.97';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=9.96','./movement-engine.js?v=9.36','./xrail-engine.js?v=9.25',
  './vs-commentary.js?v=9.91','./abilities.js?v=9.35','./scoreboard.js?v=9.27','./app.js?v=9.97',
