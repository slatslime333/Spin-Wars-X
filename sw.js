...
const CACHE='spin-wars-x-10.12';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=10.10','./ui-skin.css?v=10.00','./movement-engine.js?v=9.37','./xrail-engine.js?v=9.26',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.36','./scoreboard.js?v=10.00','./app.js?v=10.12',
  './rogue-mode.js?v=10.05','./sandbox-mode.js?v=10.09','./rogue-run-config.js?v=10.02','./rogue-run.js?v=10.06','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
