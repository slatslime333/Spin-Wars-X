...
const CACHE='spin-wars-x-10.54';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=10.34','./ui-skin.css?v=10.11','./movement-engine.js?v=9.38','./xrail-engine.js?v=9.27',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.41','./scoreboard.js?v=10.05','./app.js?v=10.31',
  './rogue-mode.js?v=10.24','./sandbox-mode.js?v=10.11','./rogue-run-config.js?v=10.03','./rogue-run.js?v=10.20','./rogue-lite-config.js?v=1.7','./rogue-lite.js?v=1.22','./rogue-balance-bridge.js?v=1.0','./rogue-balance.js?v=1.6','./rogue-shop-balance.js?v=1.3',
