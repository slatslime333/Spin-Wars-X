...
const CACHE='spin-wars-x-10.14';
const PRECACHE=[
  './','./index.html','./manifest.webmanifest',
  './style.css?v=10.10','./ui-skin.css?v=10.00','./movement-engine.js?v=9.37','./xrail-engine.js?v=9.26',
  './vs-commentary.js?v=9.93','./abilities.js?v=9.36','./scoreboard.js?v=10.01','./app.js?v=10.14',
