...
- Serve the repo root over HTTP (`python3 -m http.server 8080`) and open `index.html`. Scripts are cache-busted (`xrail-engine.js?v=7.8`, `app.js?v=7.8`, `movement-engine.js?v=7.8`); hard-refresh after pulling.
