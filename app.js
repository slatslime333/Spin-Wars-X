...
function renderHowTo(){
    ...
    <main class="menu howto">
        ...
        <section class="menu-card howto-card" id="ht-modes">
            ...
            <p><strong>Sandbox</strong> is the lab. 1 Bey or 2. Player vs CPU, Player vs Player, or CPU vs CPU. Full garage on both sides, launches you set, finishes that call out a score and keep going. Leave is the only exit. Tap a name in battle for a paused stat sheet — that works in Rogue and Quick Play too.</p>
