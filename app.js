        ...
        <section class="menu-card">
            ...
            <div class="battle-decision">
                ...
                ${choices.map(
                    ...
                    <button
                        type="button"
                        class="menu-btn gold decision-btn" data-decision-intent="${choice.intent}"
                    >
...
<div style="margin:18px 0;padding:12px;background:rgba(255,255,255,.08);border-radius:10px;">
  ...
  document.getElementById("skipButton").onclick=()=>{
    ...
    // Return to the player's combo/stat screen. CPU combo is not regenerated.
    const menuCard=document.querySelector(".menu-card");
    if(menuCard){
        menuCard.appendChild(createBackButton(()=>showComboCard()));
    }
    ...
    if(live && Game.battle.decisionActive && Game.battle.pendingDecision){
        ...
        decisionPanel=`<div style="margin-top:8px;padding:10px;border-radius:10px;border:1px solid rgba(255,212,59,.45);background:rgba(255,212,59,.06);">
            ...
            ${d.choices.map((choice,i)=>{
                ...
                return `<button type="button" class="menu-btn gold decision-btn" style="margin-top:5px;padding:8px 10px;font-size:11px;text-align:left;" data-decision-intent="${choice.intent}">
